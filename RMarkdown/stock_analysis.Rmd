...
\begin{landscape}
```{r cluster,fig.cap='K means clustering, k = 4', message = FALSE, warning = FALSE, echo = FALSE}
...
```{r pe ratio,  echo = FALSE, message = FALSE, fig.cap = 'Clusters by Sector', fig.align='center', fig.height=5,fig.width=5}
...
The final values used for the model were nrounds = 200, max_depth =
 ...
 1 and subsample = 0.8.
```{r XGBoost, message = FALSE, warning = FALSE, echo = FALSE,fig.height=5, fig.width=5,fig.align='center', fig.cap='XGBoost Tuning Parameters'}
